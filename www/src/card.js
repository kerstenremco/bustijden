      ...
      cards.push(html`
        <div class="buscard">
          <div class="buscard-header">
            ...
            <span class="bus-timer">${bus.minutesUntil} min</span>
            <svg
              class="live-icon"
              width="20px"
              height="20px"
            ...
            >
              ...
              <g class="SVGRepo_iconCarrier">
                ...
                >
                  <g
                    class="ic_fluent_live_24_regular"
                    fill="#212121"
                    fill-rule="nonzero"
                  >
                    <path
            ...
            <div class="buscard-time-details">
              <div class="route">
                <div class="route-time">
                  <span class="route-time-delay"
                    >${bus.delayInSeconds > 0
                      ? bus.arrivalTime.split(":").splice(0, 2).join(":")
                      : ""}</span
                  >
                  ${bus.calculatedArrivalTime.split(":").splice(0, 2).join(":")}
                </div>
